...
df = pd.read_csv('data/Products_ThoiTrangNam.csv')
...
df_part1.to_csv('data/Products_ThoiTrangNam_part1.csv', index=False)
df_part2.to_csv('data/Products_ThoiTrangNam_part2.csv', index=False)

# Đọc lại 2 file thành DataFrame
df1 = pd.read_csv('data/Products_ThoiTrangNam_part1.csv')
df2 = pd.read_csv('data/Products_ThoiTrangNam_part2.csv')

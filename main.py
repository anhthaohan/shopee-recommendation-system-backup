...
def load_data():
    try:
        ...
        products_chunks = []
        try:
            for chunk in pd.read_csv('data/Products_ThoiTrangNam_part1.csv', 
            ...
            for chunk in pd.read_csv('data/Products_ThoiTrangNam_part2.csv', 
                                   chunksize=chunk_size,
                                   usecols=usecols,
                                   dtype=dtypes):
                # Sanitize sensitive data
            ...
            rating_clean = pd.read_csv("data/Products_ThoiTrangNam_rating.csv", 
                                     sep='\t',
                                     usecols=['user_id', 'product_id', 'rating', 'user'],
                                     dtype={'user_id': 'int32', 
                                           'product_id': 'int32',
                                           'rating': 'float32'})
